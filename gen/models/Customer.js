...
customerSchema.methods.rent = function (car) {
    ...
    return Q().then(function() {
        ...
        if (!pass) {
            var error = new Error("Precondition violated: car_available (on 'car_rental::Customer::rent')");
            error.context = 'car_rental::Customer::rent';
            error.constraint = 'car_available';
            throw error;
        }    
    }).then(function() {
        return Q.all([
        ...
        if (!pass) {
            var error = new Error("Precondition violated: no_current_rental (on 'car_rental::Customer::rent')");
            error.context = 'car_rental::Customer::rent';
            error.constraint = 'no_current_rental';
            throw error;
        }    
    }).then(function() {
        return Q().then(function() {
