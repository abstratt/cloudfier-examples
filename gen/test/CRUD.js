...
suite('Car rental CRUD tests', function() {
    ...
    suite('Make', function() {
        ...
        test('GET entity', function(done) {
            getExactEntity('car_rental.Make').then(function(fetched) {
                entity = fetched; 
    ...
    suite('Customer', function() {
        var entity;
        test('GET entity', function(done) {
            getExactEntity('car_rental.Customer').then(function(fetched) {
                entity = fetched; 
    ...
    suite('Car', function() {
        var entity;
        test('GET entity', function(done) {
            getExactEntity('car_rental.Car').then(function(fetched) {
                entity = fetched; 
    ...
    suite('Rental', function() {
        var entity;
        test('GET entity', function(done) {
            getExactEntity('car_rental.Rental').then(function(fetched) {
                entity = fetched; 
