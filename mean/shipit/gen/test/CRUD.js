...
suite('Shipit CRUD tests', function() {
    ...
    suite('User', function() {
        ...
        test('GET entity', function(done) {
            getExactEntity('shipit.User').then(function(fetched) {
                entity = fetched; 
    ...
    suite('Label', function() {
        var entity;
        test('GET entity', function(done) {
            getExactEntity('shipit.Label').then(function(fetched) {
                entity = fetched; 
    ...
    suite('Project', function() {
        var entity;
        test('GET entity', function(done) {
            getExactEntity('shipit.Project').then(function(fetched) {
                entity = fetched; 
    ...
    suite('Issue', function() {
        var entity;
        test('GET entity', function(done) {
            getExactEntity('shipit.Issue').then(function(fetched) {
                entity = fetched; 
