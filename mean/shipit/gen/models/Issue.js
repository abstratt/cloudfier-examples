...
issueSchema.statics.reportIssue = function (project, summary, description, severity) {
    ...
    return Q().then(function() {
        ...
        return Q().then(function() {
            ...
            return Q().then(function() {
                return Q.npost(require('./Project.js'), 'findOne', [ ({ _id : project._id }) ]);
            ...
            return Q.all([
                ...
                Q().then(function() {
                    return Q.npost(require('./User.js'), 'findOne', [ ({ _id : newIssue.reporter }) ]);
...
issueSchema.methods.assign = function (newAssignee) {
    ...
    return Q().then(function() {
        ...
        return Q().then(function() {
            return Q.npost(require('./User.js'), 'findOne', [ ({ _id : newAssignee._id }) ]);
...
issueSchema.methods.addWatcher = function (userToAdd) {
    var me = this;
    return Q().then(function() {
        return Q.npost(require('./User.js'), 'findOne', [ ({ _id : userToAdd._id }) ]);
...
issueSchema.methods.vote = function () {
    ...
    return Q().then(function() {
        ...
        return Q().then(function() {
            return Q.npost(require('./User.js'), 'find', [ ({ voted : me._id }) ]);
...
issueSchema.statics.bySeverity = function (toMatch) {
    var me = this;
    return Q().then(function() {
        return mongoose.model('Issue').where({ severity : toMatch });
...
issueSchema.statics.byStatus = function (toMatch) {
    var me = this;
    return Q().then(function() {
        return require('./Issue.js').filterByStatus(mongoose.model('Issue'), toMatch);
    }).then(function(filterByStatusResult) {
        return Q.npost(filterByStatusResult, 'exec', [  ])
        ;
    });
};
/*************************** DERIVED PROPERTIES ****************/
...
issueSchema.methods.getIssueKey = function () {
    var me = this;
    return Q().then(function() {
        return Q.npost(require('./Project.js'), 'findOne', [ ({ _id : me.project }) ]);
    }).then(function(project) {
...
issueSchema.methods.isMine = function () {
    var me = this;
    return Q().then(function() {
        return Q.npost(require('./User.js'), 'findOne', [ ({ _id : me.assignee }) ]);
...
issueSchema.statics.filterByStatus = function (issues, toMatch) {
    ...
    return Q().then(function() {
        ...
        return issues.where({ status : toMatch });
    }).then(function(selectResult) {
        return Q.npost(selectResult, 'exec', [  ])
        ;
    });
...
issueSchema.methods.addComment = function (text, inReplyTo) {
    ...
    return Q().then(function() {
        return Q().then(function() {
            comment = new require('./Comment.js')();
        });
    }).then(function() {
        return Q().then(function() {
        ...
        return Q().then(function() {
            return Q.npost(require('./Comment.js'), 'findOne', [ ({ _id : inReplyTo._id }) ]);
        ...
        return Q.all([
            ...
            Q().then(function() {
                return Q.npost(require('./User.js'), 'findOne', [ ({ _id : comment.user }) ]);
            }).then(function(user) {
                return user.email;
            }),
            Q().then(function() {
                return Q.npost(require('./User.js'), 'findOne', [ ({ _id : me.reporter }) ]);
            }).then(function(reporter) {
                return reporter.email;
            }),
            Q().then(function() {
